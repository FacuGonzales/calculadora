...
var p = {
    ...
    contadorSignos: 0,
    contadorDecimal: false,
    ejecutadorResult: false
...
var m = {
    ...
    calculadora: function(event, digito){
        switch(event){
            case 'numero':
                ...
                if(p.operaciones.innerHTML == 0 ){
                    ...
                    if(p.ejecutadorResult){
                        p.ejecutadorResult = false;
                        p.operaciones.innerHTML = digito;
                    }else{
                        p.operaciones.innerHTML += digito
                    }
            ...
            case 'signo':
                ...
                if(p.contadorSignos == 1){

                    if(p.operaciones.innerHTML == 0){
                        p.operaciones.innerHTML = 0;
                    }else{
                        p.operaciones.innerHTML += digito;
                        p.contadorDecimal = false;
                        p.ejecutadorResult = false;
                    }
                }
            ...
            case 'decimal':
                ...
                if(p.operaciones.innerHTML == 0){
                    p.contadorDecimal = true;
                }else{
                    p.contadorDecimal = false;
                    if(!p.contadorDecimal && p.contadorSignos != 1){
